...
namespace EmployeeManagement.Domain.Interfaces
{
    public interface ITimeSheet
    {
        ...
        Task<bool> GetTimeByUserIDandWorkDateAsync(long userId, DateOnly workDate, CancellationToken cancellationToken);
        Task<WorkLog> AddUserTimeAsync(WorkLog workLog,CancellationToken cancellationToken);
        Task<bool> UpdateUserTimeAsync(WorkLog workLog,CancellationToken cancellationToken);
